...
document.addEventListener('DOMContentLoaded', () => {
    ...
    emailInput.addEventListener('input', () => toggleClass(emailInput, emailRegex.test(emailInput.value.trim())));
    firstNameInput.addEventListener('input', () => toggleClass(firstNameInput, nameRegex.test(firstNameInput.value.trim())));
    lastNameInput.addEventListener('input', () => toggleClass(lastNameInput, nameRegex.test(lastNameInput.value.trim())));
    passwordInput.addEventListener('input', () => toggleClass(passwordInput, passwordRegex.test(passwordInput.value)));
});
